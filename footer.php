...
<div class="container-fluid bg-dark pt-5 px-sm-3 px-md-5 mt-5">
    <div class="row py-4">
        ...
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <?php
            $popularNews = $Item->popularNews(0, 3);
            ...
            ?>
                <div class="mb-3">
                    <div class="mb-2">
                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2" href=""><?php echo $cateName ?></a>
                        <a class="text-body" href=""><small><?php echo $formattedDate ?></small></a>
                    </div>
                    <a class="small text-body text-uppercase font-weight-medium" href=""><?php echo $value['excerpt'] ?></a>
                </div>
            <?php endforeach ?>
